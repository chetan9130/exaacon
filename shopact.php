...
<head>
    ...
    <title>Shop Act Document Form</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Shop Act Document Form</h2>
        <form action="shopactsub.php" method="post" enctype="multipart/form-data">
            <!-- Entity Selection -->
            <input type="hidden" name="form_name" value="Shopact Document Submission">
